...
export const validateBrewProfileUpdateData = (req: Request, res: Response, next: NextFunction) => {

    const parsed = BrewTargetsSchema.safeParse(req.body)
    ...
    if (!parsed.success) {
        ...
        req.brewProfileUpdate = validProfile
    }
    next()
}
